...
from telegram_page.routes_event_payments      import router as event_payments_router
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://fdksignal.com","https://admin.fdksignal.com","http://localhost:8000"],
